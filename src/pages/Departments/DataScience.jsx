  ...
  >
    <h2 className="text-2xl font-bold text-[#141665] mb-6 flex items-center">
      <div className="p-2 bg-[#141665]/10 rounded-lg mr-3">
        <Binary className="w-5 h-5 text-[#141665]" />
      </div>
      {title}
    </h2>
...
const DataScienceDepartment = () => {
  ...
  const navItems = [
    ...
    { id: "labs", label: "Labs & Facilities", icon: Server },
  ...
  const focusAreas = [
    {
      ...
      icon: BrainCircuit,
      desc: "Algorithms that allow computers to learn from data without explicit programming.",
    },
    {
      title: "Big Data Analytics",
      icon: Database,
      desc: "Processing and analyzing massive datasets to uncover hidden patterns.",
    },
    {
      title: "Data Visualization",
      icon: LineChart,
      desc: "Translating complex data into graphical representations for decision making.",
    },
    {
      title: "Neural Networks",
      icon: Network,
      desc: "Deep learning models inspired by the biological neural networks of animal brains.",
    },
  ];
            ...
            <div className="space-y-8">
              <div className="prose prose-blue max-w-none text-gray-600">
                <p className="text-lg leading-relaxed font-medium text-gray-700">
                  ...
                  is a cutting-edge discipline established to address the
                  growing global demand for data-driven decision-making.
                </p>
                <p className="mt-4">
                  Our curriculum is a blend of Computer Science, Mathematics,
                  and Statistics, designed to equip students with the skills to
                  extract meaningful insights from vast and complex datasets. We
                  focus on shaping the next generation of data architects,
              ...
              <div className="bg-[#141665] rounded-xl p-6 text-white relative overflow-hidden shadow-lg mt-8">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center gap-6">
                  <div className="p-4 bg-white/10 backdrop-blur-md rounded-full border border-white/20">
                    <SearchCheck className="w-8 h-8 text-cyan-300" />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold mb-2">The Insight Lab</h3>
                    <p className="text-blue-100 text-sm leading-relaxed">
                      Our specialized research facility allows students to work
                      on real-world problems using High-Performance Computing
                      (HPC) clusters. From predicting market trends to
                      healthcare analytics, students bridge the gap between
...
export default DataScienceDepartment;
